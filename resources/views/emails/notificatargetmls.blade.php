...
<div class="container">
    ...
    <ul>
        <li>Identificativo: {{$notifica->trigger->nome}}</li>
    </ul>
    </p>

    <a class="img" href="https://cnew.mechanicallinesolutions.net/auth/login">
        <img src="https://www.mechanicallinesolutions.net/wp-content/uploads/2019/03/MLS_logo_sito-01-1-1.png" height=131>
    </a>
